...
export { ChunkResult, SynthPassResult, ResolverPool } from './ResolverPool';
...
export { matchReference, matchByFilePath, matchFunctionRef, matchDottedCallChain, matchScopedCallChain, matchFuzzy, matchMethodCall, inferCppReceiverType, localReceiverTypePatternsCached, sameLanguageFamily, crossesKnownFamily, resolveMethodOnType, preferCallSiteFile, isLexicallyReachable, normalizeInferredTypeName } from './NameMatcher';
