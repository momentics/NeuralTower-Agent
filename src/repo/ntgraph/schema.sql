...
-- Узлы графа: символы кода (функции, классы, переменные и т.д.)
...
-- Файлы: отслеживаемые исходные файлы
...
-- Неразрешённые ссылки: ссылки, требующие разрешения после полной индексации
...
-- Метаданные проекта: пары ключ-значение
...
-- Полнотекстовый индекс на имена узлов, docstring и подписи
...
-- Словарь сегментов имён для поиска символов по словам из их имён
