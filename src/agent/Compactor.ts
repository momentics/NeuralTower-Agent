...
Ответь строго одним валидным JSON-объектом, без пояснений и без markdown:
{"summary": "<текст сводки>"}

Внутри <текст сводки> содержи разделы (каждый с новой строки):
## Цель
...
Объём сводки: не более 500 слов.`
