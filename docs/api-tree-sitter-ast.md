...
потоке. Аварийное отключение: NTGRAPH_NO_STORE_WORKER=1.
...
| `AMBIGUOUS_NAME_CEILING` | `500` | Порог неоднозначности имени (настраивается через `NTGRAPH_AMBIGUOUS_NAME_CEILING`) |
