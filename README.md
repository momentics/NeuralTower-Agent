...
Агент подключается к серверу NeuralTower (SGLang/vLLM) и поддерживает чтение и запись файлов, поиск по кодовой базе, выполнение оболочечных команд, а также генерацию сообщений коммитов.
